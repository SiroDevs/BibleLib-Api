...
const uiOptions: swaggerUi.SwaggerUiOptions = {
  customSiteTitle: 'BibleLib API Docs',
  ...
  // Keep your custom CSS (adds extra styling on top of CDN CSS)
  customCss: `
    .swagger-ui .topbar { background-color: #373767; }
    .swagger-ui .topbar-wrapper img { content: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 30"><text y="22" font-size="20" font-weight="bold" fill="white">BibleLib</text></svg>'); }
